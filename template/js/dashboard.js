  ...
  $(function() {
    ...
    if ($("#audience-chart-dark").length) {
      ...
      var AudienceChart = new Chart(AudienceChartCanvas, {
        type: 'bar',
        data: {
          labels: ["Textiles", "Software", "Petroleum", "Leather", "IT and ITeS", "Manufacturing"],
          datasets: [
            {
              type: 'line',
              fill: false,
              data: [100, 200, 100, 140, 190, 140],
              borderColor: '#ff4c5b'
            },
            {
              label: '#',
        ...
        options: {
          ...
          legendCallback : function(chart) {
            ...
            text.push('<div class="d-flex align-items-center justify-content-between mb-2">');
              text.push('<p class="card-title mb-0">Land Available Sector Wise</p>');
